...
func Setup(app *fiber.App) {
	...
	tingkatan.Patch("/update-tingkatan/:id", controllers.UpdateTingkatan)
	tingkatan.Delete("/delete-tingkatan/:id", controllers.DeleteTingkatan)
	...
	pendidikan.Patch("/update-pendidikan/:id", controllers.UpdatePendidikan)
	pendidikan.Delete("/delete-pendidikan/:id", controllers.DeletePendidikan)
